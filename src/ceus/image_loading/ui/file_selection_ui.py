# Form implementation generated from reading ui file 'D:\Omid\0_main\05.01.2026\5_QuantUS-OpenSource\QuantUS\src\ceus\image_loading\ui\file_selection.ui'
#
...
"}")
        ...
        # Main horizontal layout for path selections
        self.horizontalPathLayout = QtWidgets.QHBoxLayout()
        self.horizontalPathLayout.setSpacing(30)
        self.horizontalPathLayout.setObjectName("horizontalPathLayout")

        # CEUS Image Selection Column
...
"}")
        ...
        self.horizontalPathLayout.addLayout(self.chooseImgLayout)

        # B-mode Selection Column
        self.chooseBmodeLayout = QtWidgets.QVBoxLayout()
        self.chooseBmodeLayout.setContentsMargins(20, -1, 20, -1)
        self.chooseBmodeLayout.setObjectName("chooseBmodeLayout")
        spacerItemBmode = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.chooseBmodeLayout.addItem(spacerItemBmode)
        self.bmode_path_label = QtWidgets.QLabel(parent=self.horizontalLayoutWidget)
        self.bmode_path_label.setStyleSheet("QLabel {\n"
"    background-color: rgba(255, 255, 255, 0);\n"
"    color: white;\n"
"    font-size: 17px;\n"
"}")
        self.bmode_path_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.bmode_path_label.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
        self.bmode_path_label.setObjectName("bmode_path_label")
        self.chooseBmodeLayout.addWidget(self.bmode_path_label)
        self.bmode_path_input = QtWidgets.QLineEdit(parent=self.horizontalLayoutWidget)
        self.bmode_path_input.setMinimumSize(QtCore.QSize(201, 31))
        self.bmode_path_input.setMaximumSize(QtCore.QSize(401, 31))
        self.bmode_path_input.setStyleSheet("QLineEdit {\n"
"    background-color: rgb(249, 249, 249);\n"
"    color: black;\n"
"}")
        self.bmode_path_input.setObjectName("bmode_path_input")
        self.chooseBmodeLayout.addWidget(self.bmode_path_input, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.chooseBmodeButtonsLayout = QtWidgets.QHBoxLayout()
        self.chooseBmodeButtonsLayout.setSpacing(6)
        self.chooseBmodeButtonsLayout.setObjectName("chooseBmodeButtonsLayout")
        self.choose_bmode_path_button = QtWidgets.QPushButton(parent=self.horizontalLayoutWidget)
        self.choose_bmode_path_button.setMinimumSize(QtCore.QSize(131, 41))
        self.choose_bmode_path_button.setMaximumSize(QtCore.QSize(131, 41))
        self.choose_bmode_path_button.setStyleSheet("QPushButton {\n"
"    color: white;\n"
"    font-size: 16px;\n"
"    background: rgb(90, 37, 255);\n"
"    border-radius: 15px;\n"
"}")
        self.choose_bmode_path_button.setObjectName("choose_bmode_path_button")
        self.chooseBmodeButtonsLayout.addWidget(self.choose_bmode_path_button, 0, QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.clear_bmode_path_button = QtWidgets.QPushButton(parent=self.horizontalLayoutWidget)
        self.clear_bmode_path_button.setMinimumSize(QtCore.QSize(131, 41))
        self.clear_bmode_path_button.setMaximumSize(QtCore.QSize(131, 41))
        self.clear_bmode_path_button.setStyleSheet("QPushButton {\n"
"    color: white;\n"
"    font-size: 16px;\n"
"    background: rgb(90, 37, 255);\n"
"    border-radius: 15px;\n"
"}")
        self.clear_bmode_path_button.setObjectName("clear_bmode_path_button")
        self.chooseBmodeButtonsLayout.addWidget(self.clear_bmode_path_button, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.chooseBmodeLayout.addLayout(self.chooseBmodeButtonsLayout)
        self.horizontalPathLayout.addLayout(self.chooseBmodeLayout)

        # Add horizontal path selections to the main layout
        self.img_selection_layout.addLayout(self.horizontalPathLayout)
        
        spacerItemBottom = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.img_selection_layout.addItem(spacerItemBottom)
...
" (.rf, .rfd, .mat, .bin)"))
        ...
        self.bmode_path_label.setText(_translate("select_scan_file", "Input path to B-mode file (Optional)\n"
" (.rf, .rfd, .mat, .bin)"))
        self.choose_bmode_path_button.setText(_translate("select_scan_file", "Choose B-mode"))
        self.clear_bmode_path_button.setText(_translate("select_scan_file", "Clear B-mode"))
