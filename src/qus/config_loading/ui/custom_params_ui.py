# Form implementation generated from reading ui file 'D:\Omid\0_main\05.01.2026\5_QuantUS-OpenSource\QuantUS\src\qus\config_loading\ui\custom_params.ui'
#
...
"}")
    ...
    def retranslateUi(self, customParams):
        ...
        self.sidebar.setToolTip(_translate("customParams", "<html><head/><body><p><br/></p></body></html>"))
        ...
        self.rfAnalysisLabel.setText(_translate("customParams", "QUS Analysis"))
