# Form implementation generated from reading ui file 'D:\Omid\0_main\05.01.2026\5_QuantUS-OpenSource\QuantUS\src\qus\seg_loading\ui\seg_file_selection.ui'
#
...
"}")
        ...
        self.select_seg_label = QtWidgets.QLabel(parent=constructRoi)
...
"}")
        ...
        self.seg_path_label = QtWidgets.QLabel(parent=constructRoi)
...
"}")
        ...
        self.seg_path_input = QtWidgets.QLineEdit(parent=constructRoi)
...
"}")
        ...
        self.choose_seg_path_button = QtWidgets.QPushButton(parent=constructRoi)
...
"}")
        ...
        self.clear_seg_path_button = QtWidgets.QPushButton(parent=constructRoi)
...
"}")
        ...
        self.loading_options_label = QtWidgets.QLabel(parent=constructRoi)
...
"}")
        ...
        self.loading_options_table = QtWidgets.QTableWidget(parent=constructRoi)
...
"}")
        ...
        self.accept_seg_path_button = QtWidgets.QPushButton(parent=constructRoi)
...
"}")
        ...
        self.select_seg_error_msg = QtWidgets.QLabel(parent=constructRoi)
